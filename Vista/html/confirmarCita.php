    ...
    <div id="contenedor">
        ...
        <div id="contenido">
            ...
            <table>
                ...
                <a target="_blank" href="index.php?accion=documentpdf&numero=<?php echo $fila->CitNumero;?>"><button><img src="Vista/imagenes/pdflogo.png" width="30" height="30"></button></a>
        </div>
    </div>
</body>
